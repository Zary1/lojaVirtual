...
<section class="flex  justify-center items-center mt-4 mb-[200px] gap-9 mt-9">
    ...
    <div class="bg-white shadow-lg rounded-sm p-6 flex flex-col items-center w-1/4 ">
...
w-full sm:w-1/2 md:w-1/3 lg:w-1/4 shadow-sm">
    <h2 class="text-lg font-semibold text-white">
        {{ $detalheProduto->name }}
    </h2>
    <p class="text-sm text-gray-200">
        {{ ucfirst($detalheProduto->category_name) }}
    </p>
