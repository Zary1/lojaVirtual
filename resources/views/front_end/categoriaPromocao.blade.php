...
<section class="flex flex-col justify-center items-center mt-4 mb-[200px] ">
    <h1 class="text-2xl font-bold text-center mb-6">Aproveite as melhores promoções</h1>

    @if($produts->isEmpty())
        <p class="text-center text-gray-500">Nenhum produto disponível.</p>
    @else
        <div class=" 
        grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 w-1/1 px-4">
